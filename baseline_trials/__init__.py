    ...
    def vars_for_template(player: Player):
        ...
        return dict(
            ...
            instru_countries_example=get_translation('instru_countries_example', lang,
                                                     in_dic_identity_country=dic_identity_country,
                                                     in_recip_identity_country=recip_identity_country,),
...
class UnivPage(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return dict(
            ...
            univ_norm_instru= get_translation('univ_norm_instru', lang, dictator_keeps_1 = dictator_keeps_1, receiver_gets = receiver_gets, num_people_asked=15000),
